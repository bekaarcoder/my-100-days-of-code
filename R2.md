...
### Day 26: June 27. Sunday

**Today's Progress**: Back to Django Sales App.

-   Get data from the search form
-   Create queryset and dataframes for the sales and positions
-   Display dataframes in the template

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/115d218aae60c24f118f5725010b7638e9f084cd)

### Day 27: June 28. Monday

**Today's Progress**: Django Sales App continued.

-   Created Bar, Pie and Line chart for the sales
-   Displayed all the charts in the web template
-   Generate chart based on transactions and sales date
-   Added report modal for the report form

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/9dcfd9af1366ca66eeb92c3b1060d75b32ba7d16)

### Day 28: June 29. Tuesday

**Today's Progress**: Django Sales App continued.

-   Added chart to save report modal.
-   Saving the report

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/44fd0bdf52872f33d2e79852416bafe417de3d2a)

### Day 29: June 30. Wednesday

**Today's Progress**: Django Sales App continued.

-   Added alert to report modal.
-   Created report list and report detail page.

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/fa389d305239d568a42a85bbdaf917f4cccabc01)

### Day 30: July 01. Thursday

**Today's Progress**: Django Sales App continued.

-   Created report detail page.
-   Save the report as pdf using xhtml2pdf.
-   Added favicon

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/8ec98019b81c631e56a9d0bc857aabe83854d7d0)

### Day 31: July 02. Friday

**Today's Progress**: Django Sales App continued.

-   Created Upload file page.
-   Added dropzone.js library
-   Uploading csv files using dropzone.js and populate the database with the sale reports

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/30f7f2891483fb70c5cdbccc312567bfea3908df)

### Day 32: July 03. Saturday

**Today's Progress**: Django Sales App Finished.

-   Some dropzone fixed and improvement
-   Added authentication
-   Created Sales list and detail page

**Link to work:** [Django-Sales](https://github.com/bekaarcoder/django-sales-project/commit/5a1cf139ca871ec00c79672dfb00e20f2b2d09ce)

### Day 33: July 04. Sunday

**Today's Progress**: Started learning docker

-   Docker and Container
-   Creating docker container and docker images
-   Build custom docker images
-   Build docker image and container using Dockerfile

### Day 34: July 05. Monday

**Today's Progress**: Docker

-   Port Mapping
-   Bind Mounts to sync the host machine volume with container volume
-   Read only bind mounts
-   Creating .dockerignore files
-   Adding environment variables to container

### Day 35: July 06. Tuesday

**Today's Progress**: Docker

-   Docker Compose - Buiilding image and container with docker-compose
-   Creating Docker-compose for development and production environment

### Day 36: July 07. Wednesday

**Today's Progress**: Docker Compose with Multiple Local Containers

-   Docker compose commands
-   Automatic container restarts for container failure/crash
-   Container status with docker-compose

### Day 37: July 08. Thursday

**Today's Progress**: Creating Production-Grade Workflow with Docker

-   Created a demo react app
-   Created Dockerfile for development

### Day 38: July 13. Tuesday

**Today's Progress**: Started Learning SQL

**Topics Covered:**

-   SQL Statements - Creating Tables, Inserting data, Retreiving records
-   Filtering records - Updating and Deleting records

### Day 39: July 14. Wednesday
...
### Day 40: July 15. Thursday

**Topics Covered:**

-   Grouping and Aggregating Functions, Having Clause
-   Sorting records - Order By, Limit, Offset
-   Union, Insertect and Except
